# Code to implement VAE-gumble_softmax in pytorch
# author: Devinder Kumar (devinder.kumar@uwaterloo.ca), modified by Yongfei Yan
# The code has been modified from pytorch example VAE code and inspired by the original \
# tensorflow implementation of gumbel-softmax by Eric Jang.
